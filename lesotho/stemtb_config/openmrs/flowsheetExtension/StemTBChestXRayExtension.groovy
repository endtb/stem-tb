...
public class StemTBChestXRayExtension extends BaseTableExtension<PivotTable> {
    ...
    private static Date getRowDate(PivotRow pivotRow) {
        ArrayList<BahmniObservation> obs = pivotRow.getColumns().get("StemTB, Chest Xray Date");
